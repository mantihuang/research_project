...
For basic model, I drop the variable exports and imports because the effect of government spending shock on these two variables are unclear.
$$y_t=\begin{pmatrix}  govspend_t &= \text{government spending}
\\ consump_t  &= \text{consumption}
\\ realGDP_t  &= \text{real GDP}
\\ TWI_t  &= \text{real exchange rate (trade-weighted index)}
...
Sign Restrictions are given as the following:
...
results = Posterior(Y,X,p,N,S,0.0000000000000001)
